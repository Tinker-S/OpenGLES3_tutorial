 ...
 * 圆形（多边形）
 */
class Circle(context: Context, val radius: Float, val y: Float) {
    ...
    private fun initShader(context: Context) {
        val vertexShader = ShaderUtil.loadFromAssetsFile("circle_vertex.glsl", context.resources)
